...
<template>
  <header class="w-full">
    <div
      class="w-full h-[6rem] flex items-center justify-between px-[12%] gap-4 text-base max-md:px-[7%] max-md:hidden"
    >
      <Logo />
      <Search />
    ...
    <!-- mobile v -->
    <div
      class="w-full h-[7rem] flex-col items-center gap-2 mt-4 justify-between px-[12%] text-base max-md:px-[7%] hidden max-md:flex"
    >
      <div
        class="w-full h-[6rem] flex items-center justify-between gap-4 max-md:gap-2 relative"
      >
        <Logo />
        <nav class="flex items-center gap-4 max-sm:gap-3 justify-center h-8 mx-6">
          <NuxtLink
            :to="`/${username}/create-inhalt`"
        ...
        >
            ...
            <div class="w-1/2 h-full flex flex-col gap-6 justify-center items-center">
      ...
      <div class="w-full h-max flex items-center justify-between gap-4">
        <Search />
